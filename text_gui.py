...
class LissajousTextGUI:
    ...
    def __init__(self):
        ...
        self.fig.suptitle('Anthroscilloscope - Lissajous Text Generator',
    ...
    def on_export(self, event):
        ...
        try:
            ...
            filename = f"output/text_{safe_text}_{timestamp}.wav"
...
def main():
    """Launch the GUI"""
    print("=" * 70)
    print("ANTHROSCILLOSCOPE - LISSAJOUS TEXT GENERATOR")
    print("=" * 70)
    print()
    print("Phase 3: Interactive GUI")
    print()
    print("Features:")
    ...
    print()
    print("Available characters: A-Z, 0-9, space, . , ! ? -")
    print()
    print("Launching GUI...")
    print()
